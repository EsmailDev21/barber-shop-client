...
import FetchNotifications from 'src/hoc/FetchNotifications';
...
export default function NotificationsPopover() {
  ...
  const totalUnRead = notificationState.data
    .filter((n) => n.recipientId === userId)
    .filter((item) => item.isUnread === true).length;
...
function renderContent(notification) {
  const avatar = useAppSelector(selectAuthState).data.photoUrl;
  const title = (
  ...
  if (notification.type === 'BOOKING_DONE') {
    return {
      avatar: <img alt={notification.title} src="/assets/icons/ic_notification_shipping.svg" />,
      title,
    };
  }
  if (notification.type === 'BOOKING_REFUSED') {
    return {
      avatar: <img alt={notification.title} src="/assets/icons/ic_notification_shipping.svg" />,
      title,
    };
  ...
  return {
    avatar: avatar ? <img alt={notification.title} src={avatar} /> : null,
    title,
  };
}
