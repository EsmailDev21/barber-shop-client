...
export default function UpdateServiceView({ service }: { service: Service }) {
  ...
  const [formData, setFormData] = useState({
    duration: currentService1.duration,
    name: currentService1.name,
    note: currentService1.note,
    price: currentService1.price.toString(),
    reduction: currentService1.reduction.toString(),
    genderType: currentService1.genderType,
  });
